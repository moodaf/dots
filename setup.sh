...
if [[ $choice == "y" || $choice == "Y" ]]; then
    ...
    case $rice in
        mountain)
            ...
            yay -S bspwm sxhkd rofi polybar dunst picom-jonaburg-git kitty fish mate-polkit nitrogen vscodium-bin neovim htop ly rofi-screenshot-git thunar lxappearance rofi-calc rofi-emoji zip unzip ttf-noto-nerd otf-firamono-nerd ttf-jetbrains-mono-nerd ttf-dejavu siji-ttf  ttf-unifont otf-unifont    
